const fs=require('fs');
// fs.readFile("data.json","utf-8",(err,data)=>3)
var data=[
    {
        "id" : 1,
...
fs.writeFileSync('D:/React/reactprg/src/component/json_Assesment/Men.json',JSON.stringify(Men));
fs.writeFileSync('D:/React/reactprg/src/component/json_Assesment/Women.json',JSON.stringify(Women));
fs.writeFileSync('D:/React/reactprg/src/component/json_Assesment/Kids.json',JSON.stringify(Kids));

var Mensd = fs.writeFileSync('D:/React/reactprg/src/component/json_Assesment/Men.json',JSON.stringify(Men));
